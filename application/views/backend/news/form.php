            ...
            <div class="panel-body">
                ...
                <?php echo form_hidden('article_id', $article->article_id) ?> 
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <textarea   id="summernote1" name="article1_fr" class="form-control" placeholder="<?php echo display('article')." ".$web_language->name ?>" id="article1_fr"><?php echo htmlspecialchars($article->article1_fr) ?></textarea>
                        </div>
                    </div>
                    <div class="form-group row">
