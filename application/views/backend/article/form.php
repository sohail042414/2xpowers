    ...
    <div class="col-sm-12 col-md-12">
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
                ...
                <?php echo form_open_multipart("backend/cms/content/form/$article->article_id") ?>
                <?php echo form_hidden('article_id', $article->article_id) ?> 
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input name="video" value="<?php echo $article->video ?>" class="form-control" placeholder="<?php echo display('video') ?>" type="text" id="video">
                        </div>
                    </div>
                    <div class="form-group row">
