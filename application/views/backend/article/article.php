    ...
    <div class="col-sm-12 col-md-12">
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
                ...
                <?php echo form_open_multipart("backend/cms/article/form/$article->article_id") ?>
                <?php echo form_hidden('article_id', $article->article_id) ?> 
                    ...
                    <div class="form-group row">
                        <label for="headline_fr" class="col-sm-2 col-form-label"><?php echo display('headline')." ".$web_language->name ?><i class="text-danger">*</i></label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <textarea   id="summernote1" name="article1_fr" class="form-control" placeholder="<?php echo display('article')." ".$web_language->name ?>" type="text" id="article1_fr"><?php echo htmlspecialchars($article->article1_fr) ?></textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        <label for="article2_fr" class="col-sm-2 col-form-label"><?php echo display('article')." ".$web_language->name ?></label>
                        <div class="col-sm-10">
                            <textarea   id="summernote3" name="article2_fr" class="form-control" placeholder="<?php echo display('article')." ".$web_language->name ?>" type="text" id="article2_fr"><?php echo htmlspecialchars($article->article2_fr) ?></textarea>
                        </div>
                    </div>
                    <div class="form-group row">
