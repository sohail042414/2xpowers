                    ...
                    <ul class="sidebar-menu"> 
                        ...
                        <li class="treeview <?php echo (($this->uri->segment(3) == "setting" || $this->uri->segment(3) == "language") ? "active" : null) ?>">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li class="<?php echo (($this->uri->segment(4) == "email_gateway") ? "active" : null) ?>"><a href="<?php echo base_url("backend/dashboard/setting/email_gateway") ?>">Email Gateway</a></li>
                                <li class="<?php echo (($this->uri->segment(4) == "sms_gateway") ? "active" : null) ?>"><a href="<?php echo base_url("backend/dashboard/setting/sms_gateway") ?>"> SMS Gateway </a></li>
                                <li class="<?php echo (($this->uri->segment(3) == "external_api_setup") ? "active" : null) ?>"><a href="<?php echo base_url("backend/external_api/external_api_setup/api_list") ?>"> External APIs </a></li>
...
?>
<?php if (!empty($investment) && !empty($roi)) { ?>
...
<script type="text/javascript">
    $(function(){
        $("#invest_date").on("change", function(event) {
            ...
            $.ajax({
                url: "<?php echo base_url('backend/dashboard/home/yearly_invest'); ?>",
                type: "post",
                data: inputdata,
                dataType: "script",
    ...
    $(function(){
        $("#depowith_year").on("change", function(event) {
            ...
            $.ajax({
                url: "<?php echo base_url('backend/dashboard/home/yearly_depwith'); ?>",
                type: "post",
                data: inputdata,
                dataType: "script",
                success: function(rdata) {
