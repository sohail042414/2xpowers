                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 p-0 inbox-mail">
                                <div class="inbox-avatar p-20 border-btm">
                                    ...
                                    <div class="inbox-avatar-text">
                                        ...
                                        <div><small><strong>Subject: </strong> <?php echo $message->subject;?></small></div>
                                    </div>
                                    <div class="inbox-date text-right hidden-xs hidden-sm">
                                        <div><span class="bg-green badge"><small><?php echo $message->subject;?></small></span></div>
                                        <div><small><?php echo $message->datetime;?></small></div>
                                    </div>
                                </div>
