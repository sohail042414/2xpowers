...
//Get Update file
define('MIN_VERSION', file_get_contents('https://update.bdtask.com/nishue/autoupdate/update_min_version'));
//Get Update file
define('MAX_VERSION', file_get_contents('https://update.bdtask.com/nishue/autoupdate/update_max_version'));

//Get Update file
define('UPDATE_URL','https://update.bdtask.com/nishue/autoupdate');
// Get latest version info
define('UPDATE_INFO_URL','https://update.bdtask.com/nishue/autoupdate/update_info');
// CRM temporary path
...
class Autoupdate extends CI_Controller
{
    ...
    public function index(){ 
        ...
        $data['content'] = $this->load->view("backend/autoupdate/autoupdate", $data, true);
