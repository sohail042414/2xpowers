...
class Credit extends CI_Controller {
    ...
    public function credit_list()
    {
        ...
        #pagination starts
        #
        $config["base_url"]       = base_url('customer/dashboard/credit/credit_list/'); 
        ...
        #pagination ends
        #  
        $data["content"] = $this->load->view("customer/dashboard/credit/credit_list", $data, true);
    ...
    public function send_credit()
    {
        ...
        if ($this->form_validation->run()) { 
            ...
            redirect('customer/dashboard/credit/add_credit');
    ...
    public function credit_details($id=NULL)
    {
        ...
        ->row(); 
            ...
            $data['content'] = $this->load->view("customer/credit/credit_details", $data, true);
            $this->load->view("customer/layout/main_wrapper", $data); 
