<?php 
    ...
    $path1 = [
        ...
        'output_path'      => '../gourl/lib/cryptobox.config.php',
    ];
        ...
        if ($dbvalid===true) {
            ...
            if ($Validation->checkFileExists($path['sql_path'])==false) {
                ...
                if ($FileWrite->databaseConfig($path,$_POST) === false) {
                    ...
                    $message .= "please chmod gourl/lib/cryptobox.config.php file to 777</li>";
    ...
    <body>
        ...
        <footer class="footer text-center">
            <div class="container fText">
                <div class="col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1">
                    <div class="row">
                        <div class="col-sm-6 text-left">Developed by <a  target="_blank" href="#">bdtask</a></div>
